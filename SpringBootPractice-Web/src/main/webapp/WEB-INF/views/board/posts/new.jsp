...
<div id="newPost" class="container">
    ...
    <form:form method="post" modelAttribute="post" action="${newPostUri}">
        <div class="form-group">
            ...
            <form:input path="post_title" type="text" class="form-control" id="post_title" name="post_title" placeholder="게시글 제목은 1~100자 이내로 작성할 수 있습니다."/>
        ...
        <div class="form-group" class="col-form-label">
            ...
            <form:textarea path="post_content" class="form-control" id="post_content" name="post_content" cols="10" placeholder="게시글 내용은 1~1000자 이내로 작성할 수 있습니다."/>
            <form:errors path="post_content" id="checkMessage"/>
        </div>

        <%-- 게시글 등록 푸터 영역 --%>
        <button id="newPostButton" type="submit" class="btn btn-dark">
            <i class="fas fa-pen-square"></i> 등록</button>
        <button id="newPostCancelButton" type="button" class="btn btn-default" onclick="location.href='${postListUri}'">
